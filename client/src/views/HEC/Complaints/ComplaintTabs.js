...
ComplaintTabs.propTypes = {
  ...
  getHecComplaints: PropTypes.func.isRequired,
  considerComplaint: PropTypes.func.isRequired,
  notConsiderComplaint: PropTypes.func.isRequired,
};
